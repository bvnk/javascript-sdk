...
/**
 * The CurrencyFiat model module.
 * @module model/CurrencyFiat
 * @version 1.0.1
 */
class CurrencyFiat {
    /**
     * Constructs a new <code>CurrencyFiat</code>.
     * @alias module:model/CurrencyFiat
     */
    constructor() { 
        
        CurrencyFiat.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyFiat</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyFiat} obj Optional instance to populate.
     * @return {module:model/CurrencyFiat} The populated <code>CurrencyFiat</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyFiat();
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyFiat</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyFiat</code>.
     */
 ...
 * @member {String} code
 */
CurrencyFiat.prototype['code'] = undefined;

/**
 * @member {Number} depositFee
 */
CurrencyFiat.prototype['depositFee'] = undefined;

/**
 * @member {Boolean} fiat
 * @default true
 */
CurrencyFiat.prototype['fiat'] = true;

/**
 * @member {String} icon
 */
CurrencyFiat.prototype['icon'] = undefined;

/**
 * @member {Number} id
 */
CurrencyFiat.prototype['id'] = undefined;

/**
 * @member {String} name
 */
CurrencyFiat.prototype['name'] = undefined;

/**
 * @member {Object} options
 */
CurrencyFiat.prototype['options'] = undefined;

/**
 * @member {Number} pricePrecision
 * @default 2
 */
CurrencyFiat.prototype['pricePrecision'] = 2;

/**
 * @member {Array.<Object>} protocols
 */
CurrencyFiat.prototype['protocols'] = undefined;

/**
 * @member {Number} quantityPrecision
 * @default 2
 */
CurrencyFiat.prototype['quantityPrecision'] = 2;

/**
 * @member {Boolean} supportsDeposits
 * @default true
 */
CurrencyFiat.prototype['supportsDeposits'] = true;

/**
 * @member {Boolean} supportsWithdrawals
 * @default true
 */
CurrencyFiat.prototype['supportsWithdrawals'] = true;

/**
 * @member {Number} withdrawalFee
 */
CurrencyFiat.prototype['withdrawalFee'] = undefined;

/**
 * @member {Array.<Object>} withdrawalParameters
 */
CurrencyFiat.prototype['withdrawalParameters'] = undefined;
