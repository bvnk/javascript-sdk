...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BvnkApiEndpoints.CurrencyDto();
  });
  ...
  describe('CurrencyDto', function() {
    it('should create an instance of CurrencyDto', function() {
      // uncomment below and update the code to test CurrencyDto
      //var instance = new BvnkApiEndpoints.CurrencyDto();
      //expect(instance).to.be.a(BvnkApiEndpoints.CurrencyDto);
    });
