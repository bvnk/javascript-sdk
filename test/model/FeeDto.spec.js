...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BvnkApiEndpoints.FeeDto();
  });
  ...
  describe('FeeDto', function() {
    it('should create an instance of FeeDto', function() {
      // uncomment below and update the code to test FeeDto
      //var instance = new BvnkApiEndpoints.FeeDto();
      //expect(instance).to.be.a(BvnkApiEndpoints.FeeDto);
    });
