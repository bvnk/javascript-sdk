...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BvnkApiEndpoints.TransactionReport();
  });
  ...
  describe('TransactionReport', function() {
    it('should create an instance of TransactionReport', function() {
      // uncomment below and update the code to test TransactionReport
      //var instance = new BvnkApiEndpoints.TransactionReport();
      //expect(instance).to.be.a(BvnkApiEndpoints.TransactionReport);
    });
