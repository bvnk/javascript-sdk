...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BvnkApiEndpoints.MerchantChannel();
  });
  ...
  describe('MerchantChannel', function() {
    it('should create an instance of MerchantChannel', function() {
      // uncomment below and update the code to test MerchantChannel
      //var instance = new BvnkApiEndpoints.MerchantChannel();
      //expect(instance).to.be.a(BvnkApiEndpoints.MerchantChannel);
    });
