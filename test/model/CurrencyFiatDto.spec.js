...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BvnkApiEndpoints.CurrencyFiatDto();
  });
  ...
  describe('CurrencyFiatDto', function() {
    it('should create an instance of CurrencyFiatDto', function() {
      // uncomment below and update the code to test CurrencyFiatDto
      //var instance = new BvnkApiEndpoints.CurrencyFiatDto();
      //expect(instance).to.be.a(BvnkApiEndpoints.CurrencyFiatDto);
    });
